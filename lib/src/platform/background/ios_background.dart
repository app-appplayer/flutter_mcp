...
class IOSBackgroundService implements BackgroundService {
  ...
  Future<void> initialize(BackgroundConfig? config) async {
    _logger.debug('iOS background service initializing');
  ...
  Future<bool> start() async {
    _logger.debug('iOS background service starting');
  ...
  Future<bool> stop() async {
    _logger.debug('iOS background service stopping');
...
class MCPTaskHandler extends TaskHandler {
  final MCPLogger _logger = MCPLogger('mcp.ios_task_handler');
