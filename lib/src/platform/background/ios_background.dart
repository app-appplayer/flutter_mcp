...
class IOSBackgroundService implements BackgroundService {
  ...
  Future<void> configure({
    ...
    final adjustedInterval =
        _config.intervalMs < 900000 ? 900000 : _config.intervalMs;
      ...
      case 'backgroundEvent':
        ...
        if (eventType == 'start') {
          ...
          if (timestamp != null) {
            ...
            EventSystem.instance.publishTopic('ios.background.task.completed', {
          ...
          EventSystem.instance.publishTopic('ios.background.session.ended', {
  ...
  Future<void> scheduleTask(
    ...
    try {
      ...
      final adjustedDelay =
          delay.inMilliseconds < 900000 ? Duration(minutes: 15) : delay;
      ...
      _logger.info(
          'Scheduled task $taskId with delay ${adjustedDelay.inMinutes} minutes');
    } catch (e, stackTrace) {
