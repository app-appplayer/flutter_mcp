...
class MCPPlatformNotSupportedException extends MCPException {
  ...
  MCPPlatformNotSupportedException(
    ...
    String? resolution,
          ...
          recoverable: false,
          resolution: resolution ??
              'Check if this feature is supported on your platform before using it',
        );
}
    ...
    String? resolution,
          ...
          context: {
            ...
            if (responseBody != null)
              'responseBodyPreview': responseBody.length > 100
...
class MCPOperationFailedException extends MCPException {
  ...
  MCPOperationFailedException(
      String message, this.innerError, this.innerStackTrace)
      : super(message, innerError, innerStackTrace);
...
class MCPTimeoutException extends MCPException {
  ...
  MCPTimeoutException.withContext(
    ...
    String? resolution,
          ...
          resolution: resolution ??
              'Consider increasing the timeout duration or optimizing the operation',
        );
}
...
class MCPValidationException extends MCPException {
  ...
  MCPValidationException(
    ...
    String? resolution,
          ...
          recoverable: recoverable,
          resolution:
              resolution ?? 'Please check the provided inputs and try again',
        );
...
class MCPOperationCancelledException extends MCPException {
  ...
  MCPOperationCancelledException.withContext(
    ...
    String? resolution,
          ...
          recoverable: true,
          resolution: resolution ??
              'The operation was cancelled. You can retry the operation if needed.',
        );
}
...
class MCPTransportException extends MCPException {
  ...
  MCPTransportException.withContext(
    ...
    String? resolution,
          ...
          recoverable: recoverable,
          resolution: resolution ??
              'Check transport configuration and network connectivity',
        );
}
