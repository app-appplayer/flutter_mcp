...
class TestController {
  ...
  String getInfo() =>
      'Controller: ${_repository.getServiceName()} - ${_service.getName()}';
  ...
  group('Dependency Injection Container Tests', () {
    ...
    group('Basic Registration and Resolution', () {
      ...
      test('should register and resolve instance services', () {
        final existingInstance =
            TestServiceImplementation('existing_instance', 300);
    ...
    group('Named Services', () {
      test('should support named service registration', () {
        ...
        final namedService =
            container.get<TestServiceInterface>(name: 'special');
    ...
    group('Service Lifecycle Management', () {
      test('should check if service is registered', () {
        ...
        expect(container.isRegistered<TestServiceInterface>(name: 'other'),
            isFalse);
      });
      ...
      test('should unregister named services', () {
        ...
        expect(container.isRegistered<TestServiceInterface>(), isTrue);
        expect(container.isRegistered<TestServiceInterface>(name: 'special'),
            isTrue);
        ...
        container.registerSingleton<TestServiceInterface>(
          () {
            ...
            return TestServiceImplementation(
                'singleton_$createCount', createCount);
          },
        );
    ...
    group('Performance and Load Testing', () {
      test('should handle many service registrations efficiently', () {
        ...
        for (int i = 0; i < serviceCount; i++) {
          expect(
              container.isRegistered<TestServiceInterface>(name: 'service_$i'),
              isTrue);
        }
        ...
        final service50 =
            container.get<TestServiceInterface>(name: 'service_50');
        final service99 =
            container.get<TestServiceInterface>(name: 'service_99');
      ...
      test('should handle factory instance creation efficiently', () {
        ...
        container.registerFactory<TestServiceInterface>(
          () {
            createCount++;
            return TestServiceImplementation(
                'factory_\$createCount', createCount);
          },
        );
