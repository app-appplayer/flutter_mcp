...
class MockBackgroundService extends _i1.Mock implements _i2.BackgroundService {
  ...
  @override
  _i3.Future<bool> stop() => (super.noSuchMethod(
        Invocation.method(
          #stop,
          [],
        ),
...
class MockTrayManager extends _i1.Mock implements _i7.TrayManager {
  ...
  @override
  _i3.Future<void> setIcon(String? path) => (super.noSuchMethod(
        Invocation.method(
          #setIcon,
          [path],
        ),
  ...
  @override
  _i3.Future<void> setTooltip(String? tooltip) => (super.noSuchMethod(
        Invocation.method(
          #setTooltip,
          [tooltip],
        ),
...
class MockSecureStorageManager extends _i1.Mock
  ...
  @override
  _i3.Future<Map<String, dynamic>?> readMap(String? key) => (super.noSuchMethod(
        Invocation.method(
          #readMap,
          [key],
        ),
  ...
  @override
  _i3.Future<Set<String>> getAllKeys() => (super.noSuchMethod(
        Invocation.method(
          #getAllKeys,
          [],
        ),
