...
class TestPromptPlugin implements MCPPromptPlugin {
  ...
  @override
  Future<Map<String, dynamic>> execute(Map<String, dynamic> arguments) async {
    final promptName = arguments['promptName'] as String? ?? arguments['prompt'] as String;
    final variables = arguments['variables'] as Map<String, dynamic>? ?? 
                     (arguments..remove('promptName')..remove('prompt'));
    
    return await executePrompt(promptName, variables);
  }
  
  Future<Map<String, dynamic>> executePrompt(String promptName, Map<String, dynamic> variables) async {
    if (!_initialized) {
      throw Exception('Plugin not initialized');
    }
  ...
  group('Plugin System Tests', () {
    ...
    group('Plugin Registry Basic Operations', () {
      ...
      test('should register and unregister resource plugins', () async {
        ...
        expect(registry.getPlugin<MCPResourcePlugin>('test_resource'), isNotNull);
    ...
    group('Plugin Execution', () {
      ...
      test('should execute prompt plugins', () async {
        ...
        expect(result['prompt'], equals('Hello, Alice! Welcome to FlutterMCP.'));
    ...
    group('Plugin Metadata and Discovery', () {
      test('should retrieve tool plugin metadata', () async {
        ...
        final registeredPlugin = registry.getPlugin<TestToolPlugin>('test_tool')!;
      ...
      test('should retrieve resource plugin metadata', () async {
        ...
        final registeredPlugin = registry.getPlugin<TestResourcePlugin>('test_resource')!;
      ...
      test('should retrieve prompt plugin metadata', () async {
        ...
        final registeredPlugin = registry.getPlugin<TestPromptPlugin>('test_prompt')!;
