...
void main() {
  ...
  group('Native Channel Integration Tests', () {
    ...
    group('Background Service Native Channels', () {
      test('Android background service should use correct native methods',
          () async {
        ...
        expect(
            methodCalls.any((call) => call.method == 'startBackgroundService'),
            isTrue);
        ...
        expect(
            methodCalls.any((call) => call.method == 'stopBackgroundService'),
            isTrue);
      });

      test('iOS background service should handle platform constraints',
          () async {
    ...
    group('Notification Service Native Channels', () {
      test('Android notifications should use correct channel configuration',
          () async {
    ...
    group('Event Channel Integration', () {
      test('Should handle background service events', () async {
        ...
        expect((event['data'] as Map<String, dynamic>)['action'],
            equals('taskCompleted'));
      });
      ...
      test('Should handle notification click events', () async {
        ...
        expect((event['data'] as Map<String, dynamic>)['notificationId'],
            equals('test_id'));
      });
    });
